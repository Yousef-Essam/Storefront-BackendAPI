...
describe('Testing Products Endpoints', function () {
    ...
    describe('Testing the Show Certain Product Endpoint', function () {
        ...
        it('should get product of id 4 successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/products/4')];
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(200);
                        expect(response.body).toEqual({
    ...
    describe('Testing the Create Product Endpoint', function () {
        ...
        it('should fail because the name is required', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _b = (_a = request.post('/products').send({
                            price: 500,
                            category: 'category3'
                        })).set;
                        _c = ['Authorization'];
        ...
        it('should check the existence of the 5 products', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/products')];
