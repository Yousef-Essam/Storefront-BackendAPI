...
var Dashboard = /** @class */ (function () {
    ...
    Dashboard.prototype.readOrderProducts = function (order_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot read products of order with id ".concat(order_id, ": ").concat(err_1.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Dashboard.prototype.topProducts = function (num) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [num])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows];
