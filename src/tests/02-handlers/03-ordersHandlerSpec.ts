...
describe('Testing Orders Endpoints', () => {
    ...
    describe('Testing Show Certain Order Endpoint', () => {
        ...
        it('should fail because there is no order with id of 3', async () => {
            const response = await request.get('/orders/3').set('Authorization', 'Bearer ' + await token.importToken());
        ...
        it('should successfully show the order of id 2', async () => {
            const response = await request.get('/orders/2').set('Authorization', 'Bearer ' + await token.importToken());
